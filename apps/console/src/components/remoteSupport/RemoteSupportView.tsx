...
/**
 * Remote Support — embedded MeshCentral device manager.
 *
 * MeshCentral (mesh.apexmsp.app) already renders the full device grid and every
        ...
        <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">
                Managed devices &middot; remote desktop, terminal, files &amp; power via MeshCentral
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              title="Open the full MeshCentral console in a new tab"
            >
        ...
        {showHint && (
          <div className="mt-3 flex items-start gap-2 p-3 rounded-lg bg-purple-50 border border-purple-100 text-[12px] text-purple-800">
            ...
            <div className="flex-1">
              If prompted, sign in once with your MeshCentral admin account — the session is
